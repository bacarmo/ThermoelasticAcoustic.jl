...
# Returns
- `ConvergenceResults` : L∞(L²) errors and convergence rates for `V`, `U`, `Θ`, `R`, `Z`
...
function run_convergence_study(
    ...
    # Otherwise (Nx varies, spatial or coupled) 2D fields (v, d, c) use h, and 1D fields (r, z) use Δx.
