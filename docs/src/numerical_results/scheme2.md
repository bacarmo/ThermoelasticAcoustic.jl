...
6-element Vector{ConvergenceResults}:
 ConvergenceResults: t_end=1.0, example1_manufactured(1.76), Lagrange{1}, Scheme2(), elapsed=1086.75 s
  ...
  16   -3.50  -14.00    7.08e-04  1.956    2.04e-03  1.953    5.87e-04  1.970    3.56e-03  2.089    2.56e-03  2.057
 ...
 ConvergenceResults: t_end=1.0, example1_manufactured(2.4), Lagrange{1}, Scheme2(), elapsed=1084.75 s
  Nx   log₂h   log₂τ    L∞L²_V    rate     L∞L²_U    rate     L∞L²_Θ    rate     L∞L²_R    rate     L∞L²_Z    rate
  ...
  16   -3.50  -14.00    1.25e-03  1.986    2.77e-03  2.005    1.15e-03  2.004    3.61e-03  2.057    2.79e-03  2.036
 ...
 ConvergenceResults: t_end=1.0, example1_manufactured(2.58), Lagrange{2}, Scheme2(), elapsed=2522.99 s
  Nx   log₂h   log₂τ    L∞L²_V    rate     L∞L²_U    rate     L∞L²_Θ    rate     L∞L²_R    rate     L∞L²_Z    rate
 ...
 ConvergenceResults: t_end=1.0, example1_manufactured(3.4), Lagrange{2}, Scheme2(), elapsed=2645.12 s
  Nx   log₂h   log₂τ    L∞L²_V    rate     L∞L²_U    rate     L∞L²_Θ    rate     L∞L²_R    rate     L∞L²_Z    rate
  ...
  16   -3.50  -14.00    2.32e-05  2.969    5.23e-05  2.999    2.55e-05  3.000    8.32e-05  2.944    6.16e-05  2.976
 ...
 ConvergenceResults: t_end=1.0, example1_manufactured(3.51), Lagrange{3}, Scheme2(), elapsed=6617.21 s
  Nx   log₂h   log₂τ    L∞L²_V    rate     L∞L²_U    rate     L∞L²_Θ    rate     L∞L²_R    rate     L∞L²_Z    rate
  ...
  64   -5.50  -14.00    7.28e-10  3.661    1.46e-09  3.908    7.27e-10  3.897    8.82e-09  4.075    2.66e-09  4.015

 ConvergenceResults: t_end=1.0, example1_manufactured(4.4), Lagrange{3}, Scheme2(), elapsed=6609.24 s
  Nx   log₂h   log₂τ    L∞L²_V    rate     L∞L²_U    rate     L∞L²_Θ    rate     L∞L²_R    rate     L∞L²_Z    rate
  ...
  64   -5.50  -14.00    1.66e-09  3.838    3.44e-09  3.992    1.85e-09  3.988    2.43e-08  4.098    5.88e-09  4.089

julia> cases2 = (
    (fe = Lagrange{1}, id = example2_manufactured(1.76), Nx = [2^i for i in 2:6], τ = 2.0^-14),
    (fe = Lagrange{1}, id = example2_manufactured(2.4 ), Nx = [2^i for i in 2:6], τ = 2.0^-14),
    (fe = Lagrange{2}, id = example2_manufactured(2.58), Nx = [2^i for i in 2:6], τ = 2.0^-14),
    (fe = Lagrange{2}, id = example2_manufactured(3.4 ), Nx = [2^i for i in 2:6], τ = 2.0^-14),
    (fe = Lagrange{3}, id = example2_manufactured(3.51), Nx = [2^i for i in 2:6], τ = 2.0^-14),
    (fe = Lagrange{3}, id = example2_manufactured(4.4 ), Nx = [2^i for i in 2:6], τ = 2.0^-14)
    );

julia> results2 = run_cases(Scheme2(), cases2)
6-element Vector{ConvergenceResults}:
 ConvergenceResults: t_end=1.0, example2_manufactured(1.76), Lagrange{1}, Scheme2(), elapsed=1154.17 s
  Nx   log₂h   log₂τ    L∞L²_V    rate     L∞L²_U    rate     L∞L²_Θ    rate     L∞L²_R    rate     L∞L²_Z    rate
  ...
  16   -3.50  -14.00    7.08e-04  1.982    2.09e-03  1.931    5.90e-04  1.967    1.21e-03  2.066    1.48e-03  2.029
 ...
 ConvergenceResults: t_end=1.0, example2_manufactured(2.4), Lagrange{1}, Scheme2(), elapsed=1153.86 s
  Nx   log₂h   log₂τ    L∞L²_V    rate     L∞L²_U    rate     L∞L²_Θ    rate     L∞L²_R    rate     L∞L²_Z    rate
  ...
  16   -3.50  -14.00    1.23e-03  1.986    2.73e-03  2.006    1.16e-03  2.004    1.23e-03  2.045    1.62e-03  2.025
 ...
 ConvergenceResults: t_end=1.0, example2_manufactured(2.58), Lagrange{2}, Scheme2(), elapsed=2595.45 s
  Nx   log₂h   log₂τ    L∞L²_V    rate     L∞L²_U    rate     L∞L²_Θ    rate     L∞L²_R    rate     L∞L²_Z    rate
  ...
  64   -5.50  -14.00    2.75e-07  2.429    4.40e-07  2.910    1.79e-07  2.951    4.81e-07  2.899    6.92e-07  2.966

 ConvergenceResults: t_end=1.0, example2_manufactured(3.4), Lagrange{2}, Scheme2(), elapsed=2538.94 s
  Nx   log₂h   log₂τ    L∞L²_V    rate     L∞L²_U    rate     L∞L²_Θ    rate     L∞L²_R    rate     L∞L²_Z    rate
  ...
  16   -3.50  -14.00    2.31e-05  2.963    5.23e-05  2.999    2.55e-05  3.000    2.64e-05  2.994    3.96e-05  2.978
 ...
 ConvergenceResults: t_end=1.0, example2_manufactured(3.51), Lagrange{3}, Scheme2(), elapsed=6545.05 s
  Nx   log₂h   log₂τ    L∞L²_V    rate     L∞L²_U    rate     L∞L²_Θ    rate     L∞L²_R    rate     L∞L²_Z    rate
  ...
  32   -4.50  -14.00    9.20e-09  3.891    2.19e-08  3.910    1.08e-08  3.910    1.34e-08  3.935    1.69e-08  3.992
  64   -5.50  -14.00    7.27e-10  3.660    1.46e-09  3.906    7.27e-10  3.898    9.34e-10  3.840    1.07e-09  3.975

 ConvergenceResults: t_end=1.0, example2_manufactured(4.4), Lagrange{3}, Scheme2(), elapsed=6576.60 s
  Nx   log₂h   log₂τ    L∞L²_V    rate     L∞L²_U    rate     L∞L²_Θ    rate     L∞L²_R    rate     L∞L²_Z    rate
  ...
  32   -4.50  -14.00    2.38e-08  4.001    5.48e-08  3.999    2.94e-08  3.999    1.09e-08  4.027    1.30e-08  4.003
  64   -5.50  -14.00    1.63e-09  3.868    3.45e-09  3.990    1.85e-09  3.988    8.51e-10  3.679    8.15e-10  4.000
...
2-element Vector{ConvergenceResults}:
 ConvergenceResults: t_end=1.0, example1_manufactured(2.4), Lagrange{1}, Scheme2(), elapsed=974.61 s
  Nx   log₂h   log₂τ    L∞L²_V    rate     L∞L²_U    rate     L∞L²_Θ    rate     L∞L²_R    rate     L∞L²_Z    rate
 512   -8.50   -2.00    1.15e-02  0.000    2.67e-03  0.000    1.45e-03  0.000    8.41e-03  0.000    5.85e-03  0.000
 512   -8.50   -3.00    2.21e-03  2.380    5.32e-04  2.326    3.01e-04  2.270    2.09e-03  2.011    1.50e-03  1.967
 512   -8.50   -4.00    4.45e-04  2.316    1.21e-04  2.132    6.95e-05  2.114    5.20e-04  2.004    3.77e-04  1.988
 512   -8.50   -5.00    1.02e-04  2.123    2.97e-05  2.033    1.77e-05  1.973    1.30e-04  1.998    9.48e-05  1.993

 ConvergenceResults: t_end=1.0, example2_manufactured(2.4), Lagrange{1}, Scheme2(), elapsed=719.28 s
  Nx   log₂h   log₂τ    L∞L²_V    rate     L∞L²_U    rate     L∞L²_Θ    rate     L∞L²_R    rate     L∞L²_Z    rate
 512   -8.50   -2.00    1.17e-02  0.000    2.81e-03  0.000    1.48e-03  0.000    3.96e-03  0.000    1.55e-03  0.000
 512   -8.50   -3.00    2.26e-03  2.365    5.54e-04  2.345    3.03e-04  2.287    9.45e-04  2.065    4.34e-04  1.841
 512   -8.50   -4.00    4.58e-04  2.304    1.24e-04  2.157    6.83e-05  2.151    2.31e-04  2.035    1.13e-04  1.944
 512   -8.50   -5.00    1.05e-04  2.120    3.01e-05  2.042    1.76e-05  1.956    5.75e-05  2.005    2.88e-05  1.967
