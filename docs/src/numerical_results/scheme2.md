...
ConvergenceResults: t_end=1.0, example1_manufactured(1.76), Lagrange{1}, Scheme2(), elapsed=1085.16 s
...
ConvergenceResults: t_end=1.0, example1_manufactured(2.4), Lagrange{1}, Scheme2(), elapsed=1083.26 s
  Nx   log₂h   log₂τ    L∞L²_V    rate     L∞L²_U    rate     L∞L²_Θ    rate     L∞L²_R    rate     L∞L²_Z    rate
...
ConvergenceResults: t_end=1.0, example1_manufactured(2.58), Lagrange{2}, Scheme2(), elapsed=2519.71 s
  Nx   log₂h   log₂τ    L∞L²_V    rate     L∞L²_U    rate     L∞L²_Θ    rate     L∞L²_R    rate     L∞L²_Z    rate
...
ConvergenceResults: t_end=1.0, example1_manufactured(3.4), Lagrange{2}, Scheme2(), elapsed=2652.89 s
  Nx   log₂h   log₂τ    L∞L²_V    rate     L∞L²_U    rate     L∞L²_Θ    rate     L∞L²_R    rate     L∞L²_Z    rate
...
ConvergenceResults: t_end=1.0, example1_manufactured(3.51), Lagrange{3}, Scheme2(), elapsed=6540.94 s
  Nx   log₂h   log₂τ    L∞L²_V    rate     L∞L²_U    rate     L∞L²_Θ    rate     L∞L²_R    rate     L∞L²_Z    rate
...
ConvergenceResults: t_end=1.0, example1_manufactured(4.4), Lagrange{3}, Scheme2(), elapsed=6619.90 s
  Nx   log₂h   log₂τ    L∞L²_V    rate     L∞L²_U    rate     L∞L²_Θ    rate     L∞L²_R    rate     L∞L²_Z    rate
...
6-element Vector{ConvergenceResults}:
ConvergenceResults: t_end=1.0, example2_manufactured(1.76), Lagrange{1}, Scheme2(), elapsed=1153.94 s
  Nx   log₂h   log₂τ    L∞L²_V    rate     L∞L²_U    rate     L∞L²_Θ    rate     L∞L²_R    rate     L∞L²_Z    rate
...
ConvergenceResults: t_end=1.0, example2_manufactured(2.4), Lagrange{1}, Scheme2(), elapsed=1151.86 s
  Nx   log₂h   log₂τ    L∞L²_V    rate     L∞L²_U    rate     L∞L²_Θ    rate     L∞L²_R    rate     L∞L²_Z    rate
...
ConvergenceResults: t_end=1.0, example2_manufactured(2.58), Lagrange{2}, Scheme2(), elapsed=2547.49 s
  Nx   log₂h   log₂τ    L∞L²_V    rate     L∞L²_U    rate     L∞L²_Θ    rate     L∞L²_R    rate     L∞L²_Z    rate
...
ConvergenceResults: t_end=1.0, example2_manufactured(3.4), Lagrange{2}, Scheme2(), elapsed=2568.99 s
  Nx   log₂h   log₂τ    L∞L²_V    rate     L∞L²_U    rate     L∞L²_Θ    rate     L∞L²_R    rate     L∞L²_Z    rate
...
ConvergenceResults: t_end=1.0, example2_manufactured(3.51), Lagrange{3}, Scheme2(), elapsed=6550.31 s
  Nx   log₂h   log₂τ    L∞L²_V    rate     L∞L²_U    rate     L∞L²_Θ    rate     L∞L²_R    rate     L∞L²_Z    rate
...
ConvergenceResults: t_end=1.0, example2_manufactured(4.4), Lagrange{3}, Scheme2(), elapsed=6508.83 s
  Nx   log₂h   log₂τ    L∞L²_V    rate     L∞L²_U    rate     L∞L²_Θ    rate     L∞L²_R    rate     L∞L²_Z    rate
...
ConvergenceResults: t_end=1.0, example1_manufactured(2.4), Lagrange{1}, Scheme2(), elapsed=896.20 s
  Nx   log₂h   log₂τ    L∞L²_V    rate     L∞L²_U    rate     L∞L²_Θ    rate     L∞L²_R    rate     L∞L²_Z    rate
...
ConvergenceResults: t_end=1.0, example2_manufactured(2.4), Lagrange{1}, Scheme2(), elapsed=698.45 s
  Nx   log₂h   log₂τ    L∞L²_V    rate     L∞L²_U    rate     L∞L²_Θ    rate     L∞L²_R    rate     L∞L²_Z    rate
