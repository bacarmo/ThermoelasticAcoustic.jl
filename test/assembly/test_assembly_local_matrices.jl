@testitem "assembly_local_matrix_ϕxϕ: LagrangeElement{1,1}" begin
    using ThermoelasticAcoustic: assembly_local_matrix_ϕxϕ, CartesianMesh, LagrangeElement
...
@testitem "assembly_local_matrix_∇ϕx∇ϕ: LagrangeElement{2,1}" begin
    using ThermoelasticAcoustic: assembly_local_matrix_∇ϕx∇ϕ, CartesianMesh, LagrangeElement
    using StaticArrays: SMatrix
...
@testitem "assembly_local_matrix_DG!: LagrangeElement{1,1}(), LeftRight(), ∂ₛg(x,v) = x²+v²" begin
    using ThermoelasticAcoustic: assembly_local_matrix_DG!, CartesianMesh, LagrangeElement,
                                 DOFMap,
...
@testitem "assembly_local_matrix_DF!: LagrangeElement{2,1}(), LeftRightTop(), f(s) = 1.0" begin
    using ThermoelasticAcoustic: assembly_local_matrix_DF!, assembly_local_matrix_ϕxϕ,
