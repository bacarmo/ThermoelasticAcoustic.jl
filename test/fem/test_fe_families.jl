@testitem "specialize: Lagrange" begin
    using ThermoelasticAcoustic: specialize, Lagrange, LagrangeElement
...
@testitem "specialize: Hermite" begin
    using ThermoelasticAcoustic: specialize, Hermite, HermiteElement
...
@testitem "num_local_dof: LagrangeElement" begin
    using ThermoelasticAcoustic: num_local_dof, LagrangeElement
...
@testitem "num_local_dof: HermiteElement" begin
    using ThermoelasticAcoustic: num_local_dof, HermiteElement
...
@testitem "polynomial_degree: LagrangeElement and Lagrange" begin
    using ThermoelasticAcoustic: polynomial_degree, LagrangeElement, Lagrange
...
@testitem "polynomial_degree: HermiteElement and Hermite" begin
    using ThermoelasticAcoustic: polynomial_degree, HermiteElement, Hermite
